 ...
 */
function mkktest_form_system_theme_settings_alter(&$form, &$form_state, $form_id = NULL) {
  ...
  $form['mkktest_example'] = array(
  '#type'          => 'checkbox',
  '#title'         => t('mkktest sample setting'),
  '#default_value' => theme_get_setting('mkktest_example'),
